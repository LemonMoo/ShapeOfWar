...
class MapView(tk.Frame):
    ...
    def _sync_flatgl(self):
        ...
        # markers re-pack on every pan frame -- bounded work (the symbol
        # grid is capped at _TERRAIN_SYMBOL_MAX_COUNT and the canvas pays
        # the same per-frame cost), not a regression to worry about.
