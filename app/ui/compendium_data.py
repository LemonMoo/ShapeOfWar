...
def _currency_article():
    parts = [
        ...
        (
            ...
            "can actually release for trade -- that is, settlement "
            "Gold above its own 200-unit Trade Reserve (the same "
            "reserve that keeps enough Gold on hand for your own "
            "wildland claims and construction, never touched by trade). "
            "If the buyer's paying settlement can't cover a deal in "
            "that spendable Gold, the deal is sized down or skipped "
            "entirely, not patched up with substitute goods. The "
            "seller gets whatever Gold actually arrives home -- if "
            "something else drained the buyer's spendable Gold "
            "between dispatch and delivery, the seller's haul is the "
            "smaller amount.\n\n"
